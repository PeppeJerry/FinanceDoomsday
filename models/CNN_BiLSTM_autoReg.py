...
class CNNBiLSTM(nn.Module):
    ...
    def forward(self, x):
        x_temp = x
        y = torch.zeros(x.size(0), 14, x.size(2)).to(self.device)
        for i in range(14):
    ...
    def train_model(self, train_loader, x_valid, Y_valid, epochs=500, lr=0.001, lambd=0,
